...
import com.management.hospital.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.management.hospital.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
